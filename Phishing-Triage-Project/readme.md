...
**An automated phishing email triage tool that analyzes `.eml` files for indicators of phishing, calculates a weighted risk score, maps findings to MITRE ATT&CK techniques, and logs all results to a Google Sheet for team-based investigation.**
